            ...
            <nav className="bg-zinc-900/80 backdrop-blur-sm fixed top-0 left-0 right-0 z-50 shadow-lg shadow-violet-500/10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-20">
                        <a href="#home" className="text-2xl font-bold text-white tracking-wider flex items-center">
                            <span>{portfolioData.name || "Game Designer"}</span>
                ...
                {/*<Section id="about" title="About Me" className="bg-zinc-800/50">
                    <div className="grid md:grid-cols-3 gap-6 items-center">
                        <div className="md:col-span-1 flex justify-center">
                            {/* eslint-disable-next-line @next/next/no-img-element 
                            <img src={'/profile-photo.jpg'} alt="Andre Gottgtroy" className="rounded-full w-48 h-48 md:w-60 md:h-60 object-cover border-4 border-violet-500/50 shadow-2xl" />
                        </div>
